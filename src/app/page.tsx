...
const tools = [
  { icon: "🧮", name: "Калкулатор на разходите", desc: "Изберете щат и тип бизнес. Вижте точните разходи за регистрация и годишна поддръжка.", link: "Изчисли безплатно →" },
  { icon: "📋", name: "Данъчен тест", desc: "8 въпроса, за да разберете дали и какви данъци дължите в САЩ като българско лице.", link: "Направи теста →" },
  { icon: "🗺", name: "Сравнение на щати", desc: "Wyoming, Delaware или New Mexico - коя юрисдикция е подходяща за вашия бизнес.", link: "Сравни безплатно →" },
  { icon: "🔍", name: "Търсачка в съдържанието", desc: "Намерете отговор на вашия въпрос в нашите гайдове и статии за секунди.", link: "Търси →" },
];
      ...
      <section id="tools" style={{ padding: "6rem 2.5rem" }}>
        <div className="sec">
          ...
          <div className="tools-grid">
            {tools.map((t,i) => (
              <Link key={i} href="#" className="tcard">
