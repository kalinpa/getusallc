      ...
      <div className="ftr-grid">
        ...
        <div>
          ...
          {["Основен гайд","Калкулатор","Данъчен тест","Сравнение на щати","Блог"].map(s => (
            <Link key={s} href={s === "Блог" ? "/blog" : s === "Калкулатор" ? "/tools/calculator" : "#"} style={{ display: "block", color: "rgba(255,255,255,0.65)", textDecoration: "none", fontSize: "0.88rem", fontWeight: 600, padding: "0.3rem 0" }}>{s}</Link>
          ))}
        </div>
        <div>
